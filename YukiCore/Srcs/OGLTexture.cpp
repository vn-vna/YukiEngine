...
)
{
  ...
  glTextureStorage2D(
      m_nTexID, level, (int) internalFormat, (int) size.x, (int) size.y
  );
}
...
)
{
  CHECK_VALID_TEXTURE_TYPE(m_eTexType, TextureType::TEXTURE_1D);
  glTextureSubImage1D(
      m_nTexID, level, (int) offset.x, (int) size.x, (int) imageFormat,
...
)
{
  CHECK_VALID_TEXTURE_TYPE(m_eTexType, TextureType::TEXTURE_2D);
  glTextureSubImage2D(
      m_nTexID, level, (int) offset.x, (int) offset.y, (int) size.x,
      (int) size.y, (int) imageFormat, GL_UNSIGNED_BYTE, pixels
  );
}
...
)
{
  CHECK_VALID_TEXTURE_TYPE(m_eTexType, TextureType::TEXTURE_3D);
  glTextureSubImage3D(
      m_nTexID, level, (int) offset.x, (int) offset.y, (int) offset.z,
      (int) size.x, (int) size.y, (int) size.z, (int) imageFormat,
      GL_UNSIGNED_BYTE, pixels
  );
}
