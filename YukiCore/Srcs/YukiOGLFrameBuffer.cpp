...
unsigned YukiOGLFrameBuffer::GetID() { return m_nFboID; }

bool YukiOGLFrameBuffer::IsEnabledStencilTesting() { return m_bStencilTesting; }

bool YukiOGLFrameBuffer::IsEnabledBlendMode() { return m_bBlendMode; }

bool YukiOGLFrameBuffer::IsEnabledAlphaTest() { return m_bAlphaTest; }

bool YukiOGLFrameBuffer::IsEnabledDepthTest() { return m_bDepthTest; }

bool YukiOGLFrameBuffer::IsEnabledDither() { return m_bDither; }

bool YukiOGLFrameBuffer::IsEnabledHistogram() { return m_bHistogram; }

bool YukiOGLFrameBuffer::IsEnabledLineSmooth() { return m_bLineSmooth; }

void YukiOGLFrameBuffer::EnableStencilTesting() { m_bStencilTesting = true; }

void YukiOGLFrameBuffer::EnableBlendMode() { m_bBlendMode = true; }

void YukiOGLFrameBuffer::EnableAlphaTest() { m_bAlphaTest = true; }

void YukiOGLFrameBuffer::EnableDepthTest() { m_bDepthTest = true; }

void YukiOGLFrameBuffer::EnableDither() { m_bDither = true; }

void YukiOGLFrameBuffer::EnableHistogram() { m_bHistogram = true; }

void YukiOGLFrameBuffer::EnableLineSmooth() { m_bLineSmooth = true; }


void YukiOGLFrameBuffer::DisableStencilTesting() { m_bStencilTesting = false; }

void YukiOGLFrameBuffer::DisableBlendMode() { m_bBlendMode = false; }

void YukiOGLFrameBuffer::DisableAlphaTest() { m_bAlphaTest = false; }

void YukiOGLFrameBuffer::DisableDepthTest() { m_bDepthTest = false; }

void YukiOGLFrameBuffer::DisableDither() { m_bDither = false; }

void YukiOGLFrameBuffer::DisableHistogram() { m_bHistogram = false; }

void YukiOGLFrameBuffer::DisableLineSmooth() { m_bLineSmooth = false; }

void YukiOGLFrameBuffer::BindObject() { glBindFramebuffer(GL_FRAMEBUFFER, m_nFboID); }

bool YukiOGLFrameBuffer::BufferOK() { return glCheckNamedFramebufferStatus(m_nFboID, GL_FRAMEBUFFER); }
...
void YukiOGLFrameBuffer::Create() { glCreateFramebuffers(1, &m_nFboID); }
...
void YukiOGLFrameBuffer::Render()
{
  ...
  gfxControl->SetAttributeStatus(OpenGLAttribute::STENCIL_TEST, m_bStencilTesting);
...
void YukiOGLFrameBuffer::Destroy() { glDeleteFramebuffers(1, &m_nFboID); }
