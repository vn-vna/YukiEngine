...
void YukiOGLElementBuffer::DrawElements(
    Core::PrimitiveTopology topology, unsigned start, unsigned count
)
{
  GLenum glTopology = (GLenum) topology;
  glDrawElements(
      glTopology, count, GL_UNSIGNED_INT, (void*) (start * sizeof(unsigned))
  );
}
