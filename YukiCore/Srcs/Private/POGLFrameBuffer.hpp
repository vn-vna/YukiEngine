...
public:
  ...
  void
  AttachTextureStencil(SharedPtr<IOGLTexture> tex, unsigned level) override;
  void AttachTextureDepthStencil(SharedPtr<IOGLTexture> tex, unsigned level)
      override;

  void AttachRenderBufferColor(
