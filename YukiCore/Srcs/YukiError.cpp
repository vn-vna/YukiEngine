...
String YukiError::getErrorMessage() const
{
  ...
  switch (m_ErrCode)
  {
    ...
    CHECK_CASE_OF_ERROR(YUKI_ENTITY_ADD_COMP_EXISTS,            YUKI_CORE_ERROR);          
    CHECK_CASE_OF_ERROR(YUKI_ENTITY_REM_COMP_NEXISTS,           YUKI_CORE_ERROR);          
...
MAKE_ERROR_DEFINATION(YukiEntityAddComponentExistsError,            YUKI_ENTITY_ADD_COMP_EXISTS)
MAKE_ERROR_DEFINATION(YukiEntityRemoveComponentNExistsError,        YUKI_ENTITY_REM_COMP_NEXISTS)
