...
String YukiError::getErrorMessage() const
{
  ...
  switch (m_ErrCode)
  {
    ...
    CHECK_CASE_OF_ERROR(VULKAN_CREATE_PIPELINE_LAYOUT_FAILED, YUKI_VULKAN_ERROR);
  }
  return sstr.str();
}
...
MAKE_ERROR_DEFINATION(YukiVulkanCreatePipelineLayoutError, VULKAN_CREATE_PIPELINE_LAYOUT_FAILED)
