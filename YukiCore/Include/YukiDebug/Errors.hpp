...
#define DECLARE_YUKI_ERROR(__err_name)                     \
  class Yuki##__err_name : virtual public Errors           \
  {                                                        \
  public:                                                  \
...
class Errors : virtual public std::runtime_error
{
protected:
...
public:
  Errors(const YukiErrCode& code, const String& file, const int& line);
