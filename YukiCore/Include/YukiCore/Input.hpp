...
enum class JoyStickHatState
{
  ...
  JSHAT_UP         = GLFW_HAT_UP,
  JSHAT_RIGHT      = GLFW_HAT_RIGHT,
  JSHAT_DOWN       = GLFW_HAT_DOWN,
  JSHAT_LEFT       = GLFW_HAT_LEFT,
  JSHAT_RIGHT_UP   = GLFW_HAT_RIGHT_UP,
  JSHAT_RIGHT_DOWN = GLFW_HAT_RIGHT_DOWN,
  JSHAT_LEFT_UP    = GLFW_HAT_LEFT_UP,
  JSHAT_LEFT_DOWN  = GLFW_HAT_LEFT_DOWN,
};
...
enum class KeyModifier
{
  ...
  KEYMOD_NUM_LOCK  = GLFW_MOD_NUM_LOCK,
};

typedef struct StKeyStatus
{
  KeyCode  code;
  KeyState state;
  int      scancode;
